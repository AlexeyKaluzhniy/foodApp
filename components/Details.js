...
export default Details = ({route, navigation}) => {
    ...
    const renderIngridientsItem = ({item}) => {
        return (
            <View style={[styles.IngridientItemWrapper, {
                marginLeft: item.id === '1' ? 20 : 0}
                ]}>
                <Image source={item.image} stule={styles.ingridientImage}/>
            </View>
        );
    }
            ...
            <SafeAreaView>
                <View style={styles.headerWrapper}>
                    ...
                    <View style={styles.headerLeft}>
                        <Feather name='chevron-left' size={14} color={colors.textDark}/>
                    </View>
                    </TouchableOpacity>
